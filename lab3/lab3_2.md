...
```
## [1] "C:/Users/Jessica/Desktop/BIS15W2021_JRICO/lab3"
```
...
## [1] "character"
```
characters refers to the long lines of the letters basically making the word scientists
factors is making the character be looked at as one entity rather than a line of characters
...
mean, min, max, medium etc given by summary, but don't always trust it
...
```r
#$ tells the it to look at lakeid
```
