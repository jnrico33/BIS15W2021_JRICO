...
```r
#tol is tolerance within the value specified of 8
```
...
```r
#for & , both must be true in order for this to be satified
```
...
```r
#%in%  looks for exact values
```

Macaca has the smallest mass
