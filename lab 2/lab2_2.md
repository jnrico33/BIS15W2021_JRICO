...
```
## Warning in rbind(all_harry_potter_matrix, total): number of columns of result is
...
## Deathly_Hallows_1     295.9  664.3  960.2
## Deathly_Hallows_2     381.0  960.5 1341.5
## total                2389.7 5332.9 2389.7
```
Ran this 3 times and I'm not sure how to remove the other two lines
